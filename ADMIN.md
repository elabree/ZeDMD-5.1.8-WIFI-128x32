...
| Audio (I2S) | **2× MAX98357A (Stereo)**, Pins: BCK=39, WS=38, DATA=46 — Kanalwahl per SD-Pin-Widerstand gegen 5V: L=100 kΩ, R=390 kΩ (Breakout-Boards haben 1 MΩ onboard SD→Vin) |
